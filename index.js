...
program2.name("nexclaw").description("Nexclaw CLI - A command line interface for Nexclaw").version("1.0.0");
program2.command("wakeup").description("Show the banner and pick cli or telegram mode").action(async () => {
